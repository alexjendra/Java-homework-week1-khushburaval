Feature: Nopcommerce Registration
  ...
  Background: I am on Nopcommerce Registration page
    ...
    Scenario Outline: I should not be able to register with invalid data on madatory field (*) of registration page
...
Scenario: I should be able to select any one radio button from Gender labelof your Personal Details section
